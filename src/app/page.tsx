    ...
    <>
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Pulse allows you to have conversation with any PDF document. Simply upload 
      ...
      aria-hidden is used for screen readers when we make something only to decorate the site, to make navigation easier*/}
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Chatting with the PDF files has never been easier than with Pulse.
              </p>
            </div>
          </div>
          ...
          <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
            <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:t-4">
                <span className="text-sm font-medium text-blue-600">Step 1</span>
                <span className="text-al font-semibold ">Sign up for a account</span>
            ...
            <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:t-4">
                ...
                <span className="text-al font-semibold ">Upload your PDF file</span>
                <span className="mt-2 text-zinc-700">
...
/* Installed lucide-react at Link href */